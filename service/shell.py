...
#from . import common
import common
from common import to_bytes, to_str, IPNetwork, PortRange
...
def get_config(is_local):
	...
	config['pid-file'] = config.get('pid-file', 'shadowsocksr.pid')
	config['log-file'] = config.get('log-file', 'shadowsocksr.log')
